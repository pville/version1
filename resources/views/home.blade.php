        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <h1>What We Do?</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi orci mauris, volutpat portt <br>itor lobortis et, scelerisque ac mauris. Quisque metus enim, congue quis sem ac.</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 col-sm-4" data-appear-top-offset="-100" data-animated="fadeIn">
                    ...
                    <h2>Volunteer</h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi orci </p>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="serv_links">
                        <a class="serv rokl" href="#"><div><img src="{{ asset('images/rot1.png') }}"><br><span>LOREM IPSUM</span></div></a>
                        <a class="serv rokl" href="#"><div><img src="{{ asset('images/rot2.png') }}"><br><span>LOREM IPSUM</span></div></a>
                        <a class="serv rokl" href="#"><div><img src="{{ asset('images/rot7.png') }}"><br><span>LOREM IPSUM</span></div></a>
                        <a class="serv rokl" href="#"><div><img src="{{ asset('images/rot4.png') }}"><br><span>LOREM IPSUM</span></div></a>
                        <a class="serv rokl" href="#"><div><img src="{{ asset('images/rot1.png') }}"><br><span>LOREM IPSUM</span></div></a>
                        <a class="serv rmn rokl" href="#"><div><img src="{{ asset('images/rot6.png') }}"><br><span>LOREM IPSUM</span></div></a>
                        <a class="serv rmn rokl" href="#"><div><img src="{{ asset('images/rot7.png') }}"><br><span>LOREM IPSUM</span></div></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="contactus">
        <div class="container"  data-appear-top-offset="-100" data-animated="fadeInUp">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <h1>JOIN US TODAY !</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus ut euismod turpis.
                        Duis iaculis auctor venenatis. Lorem ipsum dolor sit amet.</p>
